package com.banana.digitaldiary.android.note.note_detail
...
class NoteDetailViewModel @Inject constructor(
    ...
    private val _hasNoteBeenChanged = MutableStateFlow(false)
    val hasNoteBeenChanged = _hasNoteBeenChanged.asStateFlow()
    ...
    fun onNoteTitleChanged(text: String) {
        ...
        _hasNoteBeenChanged.value = true
    }
